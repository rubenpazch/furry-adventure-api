...
# menus
@menu1 = Profiles::Menu.create!(title: 'MENU.ORDER', link_to: '/work-order', hasSubMenu: true, isRoot: false,
                                account_id: @daniel_account.id)
@sub_menu11 = Profiles::SubMenu.create!(title: 'MENU.ORDER.NEW', link_to: '/work-order/new', hasSubMenu: false,
                                        menus_id: @menu1.id)
@sub_menu12 = Profiles::SubMenu.create(title: 'MENU.ORDER.BUSCAR', link_to: '/work-order/find', hasSubMenu: false,
                                       menus_id: @menu1.id)

@menu2 = Profiles::Menu.create!(title: 'MENU.CLIENT', link_to: '/clients', hasSubMenu: true, isRoot: false,
                                account_id: @daniel_account.id)
@sub_menu21 = Profiles::SubMenu.create!(title: 'MENU.CLIENT.NEW', link_to: '/clients/new', hasSubMenu: false,
                                        menus_id: @menu2.id)
@sub_menu22 = Profiles::SubMenu.create!(title: 'MENU.CLIENT.BUSCAR', link_to: '/clients/find', hasSubMenu: false,
                                        menus_id: @menu2.id)

@menu3 = Profiles::Menu.create!(title: 'MENU.USER.MANAGEMENT', link_to: '/apps/user-management/users',
                                hasSubMenu: false, isRoot: false, account_id: @daniel_account.id)

@menu4 = Profiles::Menu.create!(title: 'MENU.PEOPLE.MANAGEMENT', link_to: '/apps/people-management/people',
                                hasSubMenu: true, isRoot: false, account_id: @daniel_account.id)
@sub_menu41 = Profiles::SubMenu.create!(title: 'MENU.PEOPLE.MANAGEMENT.NEW', link_to: '/apps/people-management/new',
                                        hasSubMenu: false, menus_id: @menu4.id)
@sub_menu42 = Profiles::SubMenu.create!(title: 'MENU.PEOPLE.MANAGEMENT.SEARCH',
                                        link_to: '/apps/people-management/search', hasSubMenu: false, menus_id: @menu4.id)
...
# CreateRoles
@superAdmin = Role.create!(name: 'SuperAdministrator', profile_id: @super_admin_profile.id, is_root: true,
                           parent_id: 0, account_id: @global_account.id)
@admin = Role.create!(name: 'Admin', profile_id: @admin_profile.id, is_root: false, parent_id: @superAdmin.id,
                      account_id: @global_account.id)
@owner = Role.create!(name: 'Owner Optica', profile_id: @manager_profile.id, is_root: false, parent_id: @admin.id,
                      account_id: @daniel_account.id)
@itsupport = Role.create!(name: 'IT support Optica', profile_id: @manager_profile.id, is_root: false,
                          parent_id: @owner.id, account_id: @daniel_account.id)
@salesmanager = Role.create!(name: 'Sales Manager Optica', profile_id: @sales_profile.id, is_root: false,
                             parent_id: @owner.id, account_id: @daniel_account.id)
@client = Role.create!(name: 'Client Optica', profile_id: @sales_profile.id, is_root: false,
                       parent_id: @salesmanager.id, account_id: @daniel_account.id)

# super admin user
@user_admin = User.create(email: 'admin@testing.com', password: 'CuscoPeru123.', first_name: 'admin',
                          last_name: 'user', account_id: @global_account.id, isSuperAdmin: true, role_id: @superAdmin.id)
# basic user
@user_basic = User.create(email: 'basic@testing.com', password: 'CuscoPeru123.', first_name: 'basic',
                          last_name: 'user', account_id: @global_account.id, isSuperAdmin: false, role_id: @owner.id)
# sulca user
@sulca_admin = User.create(email: 'artexaperu@gmail.com', password: '^C#XeZxm-V6ptE?', first_name: 'sulca',
                           last_name: 'textiles', account_id: @account_sulca.id, isSuperAdmin: false, role_id: @owner.id)
# daniel user
@daniel_admin = User.create(email: 'daniel@gmail.com', password: '^C#XeZxm-V6ptE?', first_name: 'daniel',
                            last_name: 'lentes', account_id: @daniel_account.id, isSuperAdmin: false, role_id: @owner.id)
@daniel_sales_user1 = User.create(email: 'daniel_sales@gmail.com', password: '^C#XeZxm-V6ptE?',
                                  first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, account_id: @daniel_account.id, isSuperAdmin: false, role_id: @salesmanager.id)
@daniel_sales_user2 = User.create(email: Faker::Internet.email, password: BCrypt::Password.create('secret'),
                                  first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, account_id: @daniel_account.id, isSuperAdmin: false, role_id: @salesmanager.id)
@daniel_sales_user3 = User.create(email: Faker::Internet.email, password: BCrypt::Password.create('secret'),
                                  first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, account_id: @daniel_account.id, isSuperAdmin: false, role_id: @salesmanager.id)
@daniel_sales_user4 = User.create(email: Faker::Internet.email, password: BCrypt::Password.create('secret'),
                                  first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, account_id: @daniel_account.id, isSuperAdmin: false, role_id: @salesmanager.id)
@daniel_sales_user5 = User.create(email: Faker::Internet.email, password: BCrypt::Password.create('secret'),
                                  first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, account_id: @daniel_account.id, isSuperAdmin: false, role_id: @salesmanager.id)
@daniel_sales_user6 = User.create(email: Faker::Internet.email, password: BCrypt::Password.create('secret'),
                                  first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, account_id: @daniel_account.id, isSuperAdmin: false, role_id: @salesmanager.id)
@daniel_sales_user7 = User.create(email: Faker::Internet.email, password: BCrypt::Password.create('secret'),
                                  first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, account_id: @daniel_account.id, isSuperAdmin: false, role_id: @salesmanager.id)
@daniel_sales_user8 = User.create(email: Faker::Internet.email, password: BCrypt::Password.create('secret'),
                                  first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, account_id: @daniel_account.id, isSuperAdmin: false, role_id: @salesmanager.id)
@daniel_sales_user9 = User.create(email: Faker::Internet.email, password: BCrypt::Password.create('secret'),
                                  first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, account_id: @daniel_account.id, isSuperAdmin: false, role_id: @salesmanager.id)
@daniel_sales_user10 = User.create(email: Faker::Internet.email, password: BCrypt::Password.create('secret'),
                                   first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, account_id: @daniel_account.id, isSuperAdmin: false, role_id: @salesmanager.id)
@daniel_sales_user11 = User.create(email: Faker::Internet.email, password: BCrypt::Password.create('secret'),
                                   first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, account_id: @daniel_account.id, isSuperAdmin: false, role_id: @salesmanager.id)
@daniel_sales_user12 = User.create(email: Faker::Internet.email, password: BCrypt::Password.create('secret'),
                                   first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, account_id: @daniel_account.id, isSuperAdmin: false, role_id: @salesmanager.id)
@daniel_sales_user13 = User.create(email: Faker::Internet.email, password: BCrypt::Password.create('secret'),
                                   first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, account_id: @daniel_account.id, isSuperAdmin: false, role_id: @salesmanager.id)
@daniel_sales_user14 = User.create(email: Faker::Internet.email, password: BCrypt::Password.create('secret'),
                                   first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, account_id: @daniel_account.id, isSuperAdmin: false, role_id: @salesmanager.id)
@daniel_sales_user15 = User.create(email: Faker::Internet.email, password: BCrypt::Password.create('secret'),
                                   first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, account_id: @daniel_account.id, isSuperAdmin: false, role_id: @salesmanager.id)
@daniel_sales_user16 = User.create(email: Faker::Internet.email, password: BCrypt::Password.create('secret'),
                                   first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, account_id: @daniel_account.id, isSuperAdmin: false, role_id: @salesmanager.id)
@daniel_sales_user17 = User.create(email: Faker::Internet.email, password: BCrypt::Password.create('secret'),
                                   first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, account_id: @daniel_account.id, isSuperAdmin: false, role_id: @salesmanager.id)
@daniel_sales_user18 = User.create(email: Faker::Internet.email, password: BCrypt::Password.create('secret'),
                                   first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, account_id: @daniel_account.id, isSuperAdmin: false, role_id: @salesmanager.id)
@daniel_sales_user19 = User.create(email: Faker::Internet.email, password: BCrypt::Password.create('secret'),
                                   first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, account_id: @daniel_account.id, isSuperAdmin: false, role_id: @salesmanager.id)
@daniel_sales_user20 = User.create(email: Faker::Internet.email, password: BCrypt::Password.create('secret'),
                                   first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, account_id: @daniel_account.id, isSuperAdmin: false, role_id: @salesmanager.id)
