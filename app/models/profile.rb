class Profile < ApplicationRecord
  ...
  has_many :roles, class_name: "Profiles::Role", foreign_key: "profile_id"
  ...
  has_many :menus, through: :menu_accesses, class_name: "Profiles::MenuAccess", foreign_key: "profile_id"
end
